...
//    }
    ...
    public void takePicture() {
        mImpl.setTakePicture(1);
        mImpl.takePicture();
    }

    public String getScore(){
        String s = mImpl.getScore();
        return s;
    }

    /**
     * Take a picture. The result will be returned to
     * {@link Callback#onCameraPreview(CameraView, byte[])}.
     */
    ...
    private class CallbackBridge implements CameraViewImpl.Callback {
        ...
        @Override
        public void onCameraPreview(byte[] data) {
            for (Callback callback : mCallbacks) {
                callback.onCameraPreview(CameraView.this, data);
            }
        }

//        @Override
//        public void currentSceneScore(byte[] data){
//            for (Callback callback : mCallbacks) {
//                callback.currentSceneScore(CameraView.this,data);
//            }
//        }
    ...
    public abstract static class Callback {
         ...
         * @param data       yuv data.
         */
        public void onCameraPreview(CameraView cameraView, byte[] data) {
        }
//        public void currentSceneScore(CameraView cameraView, byte[]data){
//        }
    }
