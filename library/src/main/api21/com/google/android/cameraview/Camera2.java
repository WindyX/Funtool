...
class Camera2 extends CameraViewImpl {
    ...
    //private MyHandlerThread mMyHandlerThread = null;  // 处理拍照等工作的子线程
//    private ImageReader mPreviewImageReader;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (takepicture == 0) {
                Log.d("camera2", "preview current");
                int n_image_size = image.getWidth() * image.getHeight() * 3 / 2;
                final byte[] yuv420p = new byte[n_image_size];
                System.arraycopy(ImageUtil.getBytesFromImageAsType(image, 0), 0, yuv420p, 0, n_image_size);
                Bitmap bitmap = ColorConvertUtil.yuv420pToBitmap(yuv420p, image.getWidth(), image.getHeight());
                ASTask cnnTask = new ASTask();
                cnnTask.executeOnExecutor(Executors.newCachedThreadPool(), bitmap);
    ...
    public class ASTask extends AsyncTask<Bitmap, Object, String> {
        ...
        public String getImageScore(Bitmap bitmap) {
            ...
            return Float.toString(aestheticsScore.getScore());
        }
    }
     ...
     * 开启子线程
     */
    private static final int MSG_SCORE = 1;
    private static final int MSG_GET_SCORE = 2;
